...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 GRE
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 GRE mininput
...
//Greencoin central address, in Hex
...
extern CScript GREENCOIN_SCRIPT;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1369 / 250; // 1369 blocks /day
    }
